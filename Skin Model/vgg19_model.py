...
x = Dense(128, activation='relu', kernel_initializer='he_uniform', kernel_regularizer=l1(0.01) )(x)
x = Dropout(0.02)(x)
...
checkpoint = ModelCheckpoint(filepath='skin_model_vgg19.h5', monitor='accuracy', mode='max', verbose=2, save_best_only=True)
